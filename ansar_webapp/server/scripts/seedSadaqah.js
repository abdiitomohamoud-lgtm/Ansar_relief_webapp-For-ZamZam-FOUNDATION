...
const sadaqahData = {
  ...
  hero: {
    ...
    popularOptions: [
      { id: 'popular-1', title: 'Feed the Poor', subtitle: 'From $10', iconName: 'FaUsers' },
      { id: 'popular-2', title: 'Daily Sadaqah', subtitle: 'Recurring charity', iconName: 'FaHeart' },
      { id: 'popular-3', title: 'Water Wells', subtitle: 'Lasting benefit', iconName: 'FaWater' },
      { id: 'popular-4', title: 'Explore More', subtitle: 'See all options', iconName: 'FaArrowRight' }
    ]
  },
  sectionHeadings: {
...
async function seed() {
  ...
  console.log('Seeded sadaqah collection successfully.');
