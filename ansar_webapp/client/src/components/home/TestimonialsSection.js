    ...
    <section className="py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5 bg-secondary-50 text-secondary-600 rounded-full text-sm font-medium mb-4 shadow-sm">
            Testimonials
          </span>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Stories of <span className="text-secondary-600">Impact</span>
          </h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Hear from the people whose lives have been changed through your generous support and our programs.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <a
            href="/testimonials"
            className="inline-flex items-center bg-secondary-50 text-secondary-600 hover:bg-secondary-100 px-6 py-3 rounded-lg font-medium transition-colors shadow-sm hover:shadow group"
          >
